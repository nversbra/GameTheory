...
public class Population {
	...
	void normalSetup(double[] initFractions, double greedyDemand, Hashtable<String, Hashtable<String, Double>> mutation_frequencies){
	...
	void calc_mutation_terms(){
		...
		while(players_i.hasMoreElements()){
			...
			while(players_j.hasMoreElements()){
				...
				//System.out.println("i: " + currentPlayer + ", j: " + player_j + ", W_ij: " + mut_freq.get(currentPlayer).get(player_j));
				//System.out.println("fraction of j : " + fractions.get(player_j));
				total_mutation_effect += mut_freq.get(currentPlayer).get(player_j)*fractions.get(player_j)  - mut_freq.get(player_j).get(currentPlayer)*fractions.get(currentPlayer);
			}	
			//System.out.println("Total mutation term for fraction " + currentPlayer + ": " + total_mutation_effect);
	...
	void update(Population otherPop){
		...
		calc_mutation_terms(); //this update order keeps all fractions normalised (i.e. adding up to one within one population)
	...
	void print(){
		...
		System.out.println("Petrified fraction: " + round(fractions.get("petrified")) + " with demand: " + demands.get("petrified"));
		...
		System.out.println("Terrorist fraction: " + round(fractions.get("terrorist")) + " with demand: " + demands.get("terrorist"));
	}
	...
	public String filePrint() {
		String out= "";
		if (fractions.containsKey("greedy"))
			out += round(fractions.get("petrified")) +", " + round(fractions.get("modest")) +", " + round(fractions.get("fair"))+ ", " + round(fractions.get("greedy"))+ ", " + round(fractions.get("terrorist"));
		if (fractions.containsKey("falsifiable"))
			out += round(fractions.get("petrified")) +", " + round(fractions.get("modest")) +", " + round(fractions.get("fair"))+ ", " + round(fractions.get("falsifiable"));
		return  out;
	}
}